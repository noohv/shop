<x-app-layout>
    ...
    <form method="POST" action="{{ action([App\Http\Controllers\FoodController::class, 'store']) }}">
        ...
        <div>
            ...
            <x-input id="price" class="block mt-1 w-full" type="number" name="price" required :value="old('price')"/>
        ...
        <div>
            ...
            <x-input id="category_id" class="block mt-1 w-full" type="number" name="category_id" required :value="old('category_id')"/>
