<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endif
            <x-responsive-nav-link :href="route('orders.client')" :active="request()->routeIs('orders.client')">
                {{ __('messages.my_orders') }}
            </x-responsive-nav-link>
            @endauth
            ...
            @guest
            <button class="flex p-2 items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                <div class="px-3 py-2 bg-gray-800  text-xs font-bold uppercase rounded">
                     <a href="{{ route('login') }}" class="text-md text-white font-bold">{{ __('messages.Log In') }}</a>
                </div>
                <div class="p-3">
