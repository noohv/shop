        ...
        <div id="msg" class="hidden alert alert-danger absolute bottom-0 right-0">
            <div class="text-center py-4 lg:px-4">
                <div class="p-2 bg-gray-800 items-center text-white leading-none lg:rounded-full flex lg:inline-flex"
                    role="alert">
                    <span class="flex rounded-full bg-green-500 uppercase px-2 py-1 text-xs font-bold mr-3">{{ __('new') }}</span>
                    <span id="success" class="font-semibold mr-2 text-left flex-auto">{{ __('Item added to cart!') }}</span>
                </div>
            </div>
        </div>
